...
<script type="text/javascript" 
     src="<s:url value='/scripts/systemrole/add.js' />">
</script>
...
//var preAddActionURL = "<s:url action='userAction_preAdd' namespace='/role' includeParams='none' />";
...
<div class="content">
	...
	<s:form name="add_form" action="systemroleAction_add" namespace="/role">
