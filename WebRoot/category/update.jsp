...
<script type="text/javascript"
	src="<s:url value='/scripts/category/update.js'/>">
</script>
...
<s:text	name="product.category.update" /></div>

<div class="content">

<s:fielderror />

<s:form name="update_form"	action="categoryAction_update" namespace="/category">
	<input type="hidden" name="proCategory.id" value="<s:property value="proCategory.id" />"/>
	<table border="0" width="820px">
		<tr>
			<td class="td-right" width="150"><s:text name="product.category" /></td>
			<td class="td-left">
		...
		<tr>
		    <td class="td-right" width="150"><s:text name="product.category.brand" /></td>
